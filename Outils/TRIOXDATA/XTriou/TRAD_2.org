...
bloc_pave objet_lecture nul -1 Class to create a pave.
  ...
  attr tanh floattant tanh 1 Keyword to generate mesh with tanh (hyperbolic tangent) variation in the Y-direction.
  attr tanh_dilatation entier(into=[-1,0,1]) tanh_dilatation 1 Keyword to generate mesh with tanh (hyperbolic tangent) variation in the Y-direction. tanh_dilatation: The value may be -1,0,1 (0 by default): 0: coarse mesh at the middle of the channel and smaller near the walls 1: coarse mesh at the bottom of the channel and smaller near the top -1: coarse mesh at the top of the channel and smaller near the bottom.
  ...
  attr xtanh_dilatation entier(into=[-1,0,1]) xtanh_dilatation 1 Keyword to generate mesh with tanh (hyperbolic tangent) variation in the X-direction. xtanh_dilatation: The value may be -1,0,1 (0 by default): 0: coarse mesh at the middle of the channel and smaller near the walls 1: coarse mesh at the bottom of the channel and smaller near the top -1: coarse mesh at the top of the channel and smaller near the bottom.
...
schema_euler_implicite schema_implicite_base schema_euler_implicite -1 This is the Euler implicit scheme.
