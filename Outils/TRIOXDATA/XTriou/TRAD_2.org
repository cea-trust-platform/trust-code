...
frottement_interfacial source_base frottement_interfacial 0 Source term which corresponds to the phases friction at the interface
  attr bulles chaine bulles 1 Correlation for friction in bubbly flows
  attr bloc_bulles bloc_b bloc_bulles 1 not set
  attr sonnenburg chaine sonnenburg 1 Correlation for drift flux de Sonnenburg
  attr wallis chaine wallis 1 Correlation for friction in annular flows
