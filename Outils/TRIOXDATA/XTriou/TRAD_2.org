...
raffiner_anisotrope interprete raffiner_anisotrope -1 To allows to cut triangle or tetrahedra elements respectively in 3 or 4 new ones by defining a new summit located at the center of the element. Note that such a cut creates flat elements (anisotropic). \includepng{{raffineraniso.pdf}}{{10}}
  attr domain_name ref_domaine domain_name 0 Name of domain.
raffiner_isotrope interprete raffiner_isotrope -1 To allows to cut triangles/quadrangles or tetrahedral/hexaedras elements respectively in 4 or 8 new ones by defining new summits located at the middle of edges (and center of faces and elements for quadrangles and hexaedra). Such a cut preserves the shape of original elements (\`isotropic\`). \includepng{{raffineriso.pdf}}{{10}} NL2 \includepng{{raffinerisorect.pdf}}{{10}}
  attr domain_name ref_domaine domain_name 0 Name of domain.
