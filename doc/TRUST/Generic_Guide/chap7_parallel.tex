...
You can see the documentation of \href{\REFERENCEMANUAL\#partition}{this part in the \trust Reference Manual}.\\
...
\begin{itemize}
\item the external partitionning library \href{http://glaros.dtc.umn.edu/gkhome/views/metis}{\textbf{"METIS"}} (open source). It is a general algorithm that will generate a partition of the domain (cf \href{\REFERENCEMANUAL\#partitionneurmetis}{\trust Reference Manual}),
\begin{center}
