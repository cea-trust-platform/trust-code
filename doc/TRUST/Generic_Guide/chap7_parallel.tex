\trust is a plateform which allow to make parallel calculation following some basic rules:
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Adding a partitionning block}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
You can see the documentation of \href[page=DOCLINK_PARTITION]{User_Manual_TRUST.pdf}{this part} in the User's Manual.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Adding a block to read the sub-domains}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Then modify the \textit{CUTTING\_data\_file.data} file:
\begin{itemize}
...
\textcolor{blue}{{\bf{Read\_file}} \textit{my\_mesh.geo} ;}

\textcolor{blue}{[{\bf{Trianguler\_h}} \textit{my\_domain}]}
...
\end{minipage}}
\end{center}
This will read your \textit{DOM\_000n}\textbf{.Zones} files. You can see the documentation of the \textbf{"scatter"} keyword in \href[page=DOCLINK_SCATTER]{User_Manual_TRUST.pdf}{this part} of the User's Manual.\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Partitionning: "Assisted" method}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Here we will use the script \verb make_PAR.data  to make the partitioning step.
...
\textbf{Be carefull} to the hashtags "\textcolor{blue}{\textbf{\#}}", they are interpreted by the script!\\

Then to made automatically the partitioning step and obtain the parallel data file, you have to run:
\begin{verbatim}
...
For more information, you can go to see this \href{TRUST_tutorial.pdf\#exo_para_2}{exercise} in the TRUST tutorial.
...
\begin{itemize}
\item the external partitionning library \href{http://glaros.dtc.umn.edu/gkhome/views/metis}{\textbf{"METIS"}} (open source). It is a general algorithm that will generate a partition of the domain (cf \href[page=245]{User_Manual_TRUST.pdf}{\trust documention here}),
\begin{center}
...
\item internal \trust partitioning tools:
    \begin{itemize}
    \item \href[page=246]{User_Manual_TRUST.pdf}{\textbf{Tranche}} which make parts by cutting the domain following x, y and/or z directions.
    \begin{center}
    \fbox{ \begin{minipage}[c]{0.4\textwidth}
    \begin{alltt} 
    ...
    \item \href[page=247]{User_Manual_TRUST.pdf}{\textbf{Sous\_Zones}} which will create one part for each specified subzone.
    \begin{center}
    ...
    \item \href[page=247]{User_Manual_TRUST.pdf}{\textbf{Partition}} which re-use the partition of a domain.
    \begin{center}
    \fbox{ \begin{minipage}[c]{0.4\textwidth}
    \begin{alltt} 
    ...
    \item \href[page=247]{User_Manual_TRUST.pdf}{\textbf{Fichier\_Decoupage}} which reads an array of integer values on the disc, one value for each mesh element. The number of parts created is the highest value in the array plus one.
    \begin{center}
    \fbox{ \begin{minipage}[c]{0.6\textwidth}
    \begin{alltt} 
...
You can see the \href[page=82]{TRUST_and_TrioCFD_presentation.pdf}{slides of \trust presentation} about parallel for more informations and those two exercise of the tutorial: \href{TRUST_tutorial.pdf\#exo_para_1}{exercise 1} and \href{TRUST_tutorial.pdf\#prm_para}{exercise 2}.
...
\trust can create a submission file for you on clusters on which the support team has done installations.
...
You obtain a file named \textbf{"sub\_file"}, you can open it and verify/change values(for example the name of the job, the number of processors, the name of the exe, ...).\\
...
You can see the \href[page=82]{TRUST_and_TrioCFD_presentation.pdf}{slides of \trust presentation} about parallel for more informations and \href{TRUST_tutorial.pdf\#exo_para_3}{this exercise of the \trust tutorial}.
...
You can have a look at the \href{TRUST_tutorial.pdf\#exo_para_3}{cluster exercise} in the \trust tutorial or at the \href[page=96]{TRUST_and_TrioCFD_presentation.pdf}{slides of \trust presentation}.
...
\begin{verbatim}
> make_PAR.data data_file_name [parts_number]
\end{verbatim}
...
\item modify the \textit{PAR\_my\_data\_file.data} file \underline{without} running \verb make_PAR.data  script.
\end{itemize}
