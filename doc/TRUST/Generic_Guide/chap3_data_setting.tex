...
You can find all \href[page=DOCLINK_PROBLEMS]{User_Manual_TRUST.pdf}{problem types} in the User's Manual.
...
\begin{itemize}
\item \href[page=DOCLINK_READ]{User_Manual_TRUST.pdf}{\textbf{Read\_MED}} for a MED file from \href{http://www.salome-platform.org}{Salom\'e}, \href{http://gmsh.info/}{Gmsh},... ,

\item \href[page=DOCLINK_READ]{User_Manual_TRUST.pdf}{\textbf{Read\_File}} for a binary mesh file from \href{http://resource.ansys.com/Products/Other+Products/ANSYS+ICEM+CFD}{ICEM},

\item for another format, see the \href[page=DOCLINK_READ]{User_Manual_TRUST.pdf}{User's Manual}.
\end{itemize}
...
\begin{itemize}
\item \href[page=DOCLINK_TRIANGULATE]{User_Manual_TRUST.pdf}{\textbf{Trianguler}} to triangulate your 2D cells and create an unstructured mesh.

\item \href[page=DOCLINK_TETRAHEDRALISE]{User_Manual_TRUST.pdf}{\textbf{Tetraedriser}} to tetrahedralise 3D cells and create an unstructured mesh.

\item \href[page=DOCLINK_REFINE]{User_Manual_TRUST.pdf}{\textbf{Raffiner\_anisotrope/Raffiner\_isotrope}} to triangulate/tetrahedralise elements of an untructured mesh.

\item \href[page=DOCLINK_EXTRUDE]{User_Manual_TRUST.pdf}{\textbf{ExtrudeBord}} to generate an extruded mesh from a boundary of a tetrahedral or an hexahedral mesh. \Note that ExtrudeBord in VEF generates 3 or 14 tetrahedra from extruded prisms.

\item \href[page=DOCLINK_GATHER BOUNDARIES]{User_Manual_TRUST.pdf}{\textbf{RegroupeBord}} to build a new boundary with several boundaries of the domain.

\item \href[page=DOCLINK_TRANSFORMER]{User_Manual_TRUST.pdf}{\textbf{Transformer}} to transform the coordinates of the geometry.

\item for other commands, see the \href{User_Manual_TRUST.pdf}{User's Manual}.
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The keyword \href[page=37]{User_Manual_TRUST.pdf}{\textbf{Discretiser\_domaine}} is useful to discretize the domain (faces will be created) without defining a problem.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
You have to specify the \href[page=DOCLINK_DISCRETIZATION]{User_Manual_TRUST.pdf}{discretization type} which can be \textbf{VDF}, \textbf{EF} or \textbf{VEFPreP1B}.\\
...
You can add parameters to your discretization with the optional keyword \textbf{"\href[page=DOCLINK_DISCRETIZATION]{User_Manual_TRUST.pdf}{Read}"}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Here are some \href[page=DOCLINK_TIME SCHEMES]{User_Manual_TRUST.pdf}{available types of explicit schemes}:
\begin{itemize}
\item \textbf{Scheme\_Euler\_explicit}
\item \textbf{Schema\_Adams\_Bashforth\_order\_2}
%\item \textbf{Schema\_Adams\_Bashforth\_order\_3}
%\item \textbf{Runge\_Kutta\_Rationnel\_ordre\_2}
\item \textbf{Runge\_Kutta\_ordre\_3}
...
\begin{itemize}
\item \textbf{Scheme\_Euler\_implicit}
%\item \textbf{Schema\_Adams\_Moulton\_order\_2}
\item \textbf{Schema\_Adams\_Moulton\_order\_3}
...
\begin{itemize}
\item \textbf{Fluide\_incompressible}
%\item \textbf{Fluide\_Ostwald}
%\item \textbf{Constituant}
\item \textbf{Solide}
\item for other types and more information see \href[page=DOCLINK_MEDIUM SPECIFICATION]{User_Manual_TRUST.pdf}{User's Manual}.
\end{itemize}
...
a uniform field, no matter his name. For example:
...
For this, we must use the \href[page=DOCLINK_ASSOCIATE]{User_Manual_TRUST.pdf}{\textbf{Associate}} interpretor:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Coupled calculation ??}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Then you must discretize your domain using the \href[page=DOCLINK_DISCRETIZATION]{User_Manual_TRUST.pdf}{\textbf{Discretize}} interpretor:
