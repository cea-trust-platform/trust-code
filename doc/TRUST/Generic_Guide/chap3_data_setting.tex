...
You can add parameters to your discretization with the optional keyword \href{../../Outils/TRIOXDATA/XTriou/doc.pdf\#read}{\textbf{Read}} (see \href{../../Outils/TRIOXDATA/XTriou/doc.pdf\#vefprep1b}{\textbf{VEFPreP1B discretization}}).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Here are some \href[page=DOCLINK_TIME SCHEMES]{../../Outils/TRIOXDATA/XTriou/doc.pdf}{available types of explicit schemes}:
...
%And also some \href[page=DOCLINK_TIME SCHEMES]{../../Outils/TRIOXDATA/XTriou/doc.pdf}{available types of implicit schemes}:
...
For other scheme, see \href{../../Outils/TRIOXDATA/XTriou/doc.pdf\#schematempsbase}{this section} of the Reference Manual.\\
