...
For more details, see the \href[page=DOCLINK_PROBLEM RESOLUTION]{User_Manual_TRUST.pdf}{User's Manual}. \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Stop running calculation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
You may use the \textit{my\_data\_file}\textbf{.stop} file, if you want to stop properly your calculation (i.e. with all saves).
...
For more details, see the \href[page=DOCLINK_SAVING A PROBLEM]{User_Manual_TRUST.pdf}{User's Manual}. \\
...
For examples, see the \href{TRUST_tutorial.pdf\#save_restart}{tutorial} and the \href[page=DOCLINK_RESTARTING A PROBLEM]{User_Manual_TRUST.pdf}{User's Manual}.\\

\Note that you can run a calculation with initial condition read into a save file (.xyz or .sauv) from a previous calculation using \textbf{Champ\_Fonc\_reprise} or read a into a MED file with \textbf{Champ\_Fonc\_MED} (see \href[page=DOCLINK_STATIONARY FIELDS]{User_Manual_TRUST.pdf}{User's Manual} for more information).
