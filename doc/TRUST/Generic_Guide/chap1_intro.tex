...
\begin{itemize}
\item \textbf{\textcolor{darkblue}{Partitionning: "By hand" method}}\\
...
This will read your \textit{DOM\_000n}\textbf{.Zones} files. You can see the documentation of the \textbf{"scatter"} keyword in \href{\REFERENCEMANUAL\#scatter}{this part of the \trust Reference Manual}.\\
\end{itemize}
