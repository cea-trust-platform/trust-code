...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Then you may indicate the choice of pressure solver (cf \href{\REFERENCEMANUAL\#solveursysbase}{\trustref Reference Manual}) using the following syntaxe:
    \begin{center}
...
To see the syntaxe of each available initial condition: cf \href{\REFERENCEMANUAL\#condinits}{\trustref Reference Manual}.
...
\item refer to \href{\REFERENCEMANUAL\#fieldbase}{\trustref Reference Manual}.
\end{itemize}
...
To choose your "boundary\_field\_type" parameters, refer to \href{\REFERENCEMANUAL\#frontfieldbase}{\trustref Reference Manual}.
...
For complete syntax, see the \trustref Reference Manual \href{\REFERENCEMANUAL\#corpspostraitement}{here}, and for all options see the \href{\REFERENCEMANUAL\#statsposts}{\trust Reference Manual}.
\end{itemize}
