...
For more information on thermohydraulique QC problem, go \href{\REFERENCEMANUAL\#pbthermohydrauliqueqc}{here} and for thermohydraulique turbulent QC problem, go \href{\REFERENCEMANUAL\#pbthermohydrauliqueturbulentqc}{there}.
...
For more information, see the \href{\REFERENCEMANUAL\#pbconduction}{\trust Reference Manual}.
...
You can see the documentation of this kind of problem in the \href{\REFERENCEMANUAL\#coupledproblem}{\trust Reference Manual}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Then you may indicate the choice of pressure solver (cf \href{\REFERENCEMANUAL\#solveursysbase}{\trust Reference Manual}) using the following syntaxe:
    \begin{center}
...
%\item \textbf{Gmres} or \textbf{Gen} or \textbf{Optimal} (cf to the \href[page=DOCLINK_OTHER SOLVERS]{\REFERENCEMANUAL}{\trust Reference Manual}).
\end{itemize}
...
\section{Convection}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
There is no default convectif scheme so you must choose one \href{\REFERENCEMANUAL\#blocconvection}{convection scheme}:
    \begin{center}
...
\item for more, see the \href{\REFERENCEMANUAL\#blocconvection}{\trust Reference Manual}.
\end{itemize}
...
You can choose your scheme with the help of the \href{\REFERENCEMANUAL\#blocdiffusion}{\trust Reference Manual}.\\
...
To see the syntaxe of each available initial condition: cf \href{\REFERENCEMANUAL\#condinits}{\trust Reference Manual}.
...
%\item for more, see the \href{\REFERENCEMANUAL\#condinits}{\trust Reference Manual}.
\end{itemize}

We list here some "field\_type":
\begin{itemize}
\item \href{\REFERENCEMANUAL\#uniformfield}{\textbf{Uniform\_Field}}: for uniform field,
...
\item \href{\REFERENCEMANUAL\#fieldfunctxyz}{\textbf{Champ\_Fonc\_txyz}}: for a field which depends on the time and the space,
...
\item \href{\REFERENCEMANUAL\#champfoncreprise}{\textbf{Champ\_Fonc\_Reprise}}: to read a data field in a save file (.xyz or .sauv) at a specified time.
\item refer to \href{\REFERENCEMANUAL\#fieldbase}{\trust Reference Manual}.
\end{itemize}
...
You can find help for boundary conditions in the \href{\REFERENCEMANUAL\#condlimbase}{\trust Reference Manual}.
...
\item for more, see the \href{\REFERENCEMANUAL\#condlimbase}{\trust Reference Manual}.
\end{itemize}
}}

To choose your "boundary\_field\_type" parameters, refer to \href{\REFERENCEMANUAL\#frontfieldbase}{\trust Reference Manual}.
...
\item for more, see the \href{\REFERENCEMANUAL\#modeleturbulencehydderiv}{\trust Reference Manual}.
\end{itemize}
...
But you can also create a list of postprocessing with \href{\REFERENCEMANUAL\#postraitements}{\textbf{Post\_processings}} keyword (named with Post\_name1, Post\_name2, etc...), in order to print results to several formats or with different time periods, or into different results files:
\begin{center}
...
For more informations, you can see the \href{\REFERENCEMANUAL\#champsapost}{\trust Reference Manual}.
%\vspace{1cm}

\item \textcolor{darkblue}{\textbf{Creating new fields}}

The \href{\REFERENCEMANUAL\#definitionchamps}{\textbf{Definition\_champs}} keyword is used to create new or more complex field for advanced postprocessing.
...
%\item Predefini
%\item Tparoi\_VEF
\item for details and other keywords, see the \href{\REFERENCEMANUAL\#definitionchamps}{\trust Reference Manual}.
\end{itemize}
...
For complete syntax, see the \href{\REFERENCEMANUAL\#corpspostraitement}{\trust Reference Manual}, also for \href{\REFERENCEMANUAL\#sondes}{all options}.
...
You can see the \href{\REFERENCEMANUAL\#corpspostraitement}{complete syntax} and \href{\REFERENCEMANUAL\#champsposts}{all options} in the \trust Reference Manual.
...
For complete syntax, see the \trust Reference Manual \href{\REFERENCEMANUAL\#corpspostraitement}{here}, and for all options see the \href{\REFERENCEMANUAL\#statsposts}{\trust Reference Manual}.
\end{itemize}
