...
section \ref{Ref-coupledproblem} of the Reference Manual\\
...
%\item \textbf{Gmres} or \textbf{Gen} or \textbf{Optimal} (cf to the \href[page=DOCLINK_OTHER SOLVERS]{TRUST_Reference_Manual.pdf}{\trust Reference Manual}).
\end{itemize}
...
%\item for more, see the \href{TRUST_Reference_Manual.pdf\#condinits}{\trust Reference Manual}.
\end{itemize}
...
For more informations, you can see the \href{TRUST_Reference_Manual.pdf\#champsapost}{\trust Reference Manual}.
%\vspace{1cm}
...
You can find other examples in the \href[page=66]{TRUST_and_TrioCFD_presentation.pdf}{TRUST \& TrioCFD presentation} or in the \href[page=233]{TRUST_Reference_Manual.pdf}{\trust Reference Manual}.
