...
Velocity residual                               & \textbf{Vitesse_residu}                   & $m.s^{-2}$ \\ \hline
...
Temperature residual                            & \textbf{Temperature_residu}               & $^o$C.$s^{-1}$ or K.$s^{-1}$ \\ \hline
...
Constituent concentration residual              & \textbf{Concentration_residu}             & \\ \hline
