...
\textcolor{blue}{\# By default each boundary condition of the domain is already extracted }

\textcolor{blue}{\hspace{0.2cm} with names such as "my\_dom"\_boundaries\_"my\_BC" \#}
...
\hspace{2cm}                \textcolor{blue}{\# Physical characteristics of medium \#}

\hspace{2cm}                {\bf{Fluide\_Incompressible}}

\hspace{2cm}                \{

\hspace{3cm}                ...

\hspace{3cm}                \textcolor{blue}{\# Gravity vector definition \#}

\hspace{3cm}                \textit{gravity} {\bf{Uniform\_field}} \textit{2 0 -9.81}
