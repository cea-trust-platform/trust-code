...
\title[TRUST Baltik Project Tutorial V1.8.0beta]{TRUST Baltik Project Tutorial V1.8.0beta}
...
\item "Interprete\_geometrique\_base::interpreter\_()" method is called first,
...
\hspace{0.6cm} \texttt{(gdb) up 5 \textcolor{blue}{\# Move up 5 levels}}\\
\hspace{0.6cm} \texttt{(gdb) list 900}
\begin{itemize}
