...
\title[TRUST Baltik Project Tutorial V1.9.2beta]{TRUST Baltik Project Tutorial V1.9.2beta}
...
\begin{alltt}
 my\_new\_keyword \{ {\bf{dimension}} 3 {\bf{option}} fast \}
\end{alltt}
\end{minipage}}
\end{center}
