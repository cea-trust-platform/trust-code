...
%    $\rightarrow$ "See here how to configure Eclipse with TRUST project." \\
    \item [$\circ$] open the README\_ECLIPSE file: \\
    \texttt{\$ vim|nedit|gedit|emacs \$TRUST\_ROOT/src/README\_ECLIPSE \&}\\
    \item [$\circ$] Do only the first part (Create a platform TRUST project).\\
    \end{itemize}
...
\item Now we will add comments in our cpp files to add informations in the documentation.
