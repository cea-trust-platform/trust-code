...
\title[TRUST Baltik Project Tutorial V1.9.1beta]{TRUST Baltik Project Tutorial V1.9.1beta}
...
\item In "More Downloads", select version  \textbf{Eclipse 2022-06 (4.24)}.
\item Select \textbf{Eclipse IDE for C/C++ Developers} $\rightarrow$ \textbf{Linux 64-bits}
\item Download the \textbf{eclipse-cpp-2022-06-R-linux-gtk-x86\_64.tar.gz} package in your directory \texttt{Formation\_TRUST/yourname}
...
\item Have a look at the "Interprete\_geometrique\_base" sub-class "Extruder" which is very similar to what we want. The data file syntax is:
\begin{center}
\fbox{ \begin{minipage}[c]{0.9\textwidth}
\begin{alltt}
...
\begin{frame}
\frametitle{Modify your cpp class}
\begin{block}{Part 2: Compute the sum of the control volumes of a domain discretized in VEF}
\begin{itemize}
