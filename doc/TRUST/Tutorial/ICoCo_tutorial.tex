...
\title[TRUST ICoCo Tutorial V1.8.3beta]{TRUST ICoCo Tutorial V1.8.3beta}
...
\begin{itemize}
\item On CEA Saclay PCs and callisto cluster, TRUST versions are available with (e.g. X.Y.Z=1.8.0):\\
...
> cd ThHyd\_keps\_VEF\_ICoCo \\
> compare\_lata ThHyd\_keps\_VEF.lata ../ThHyd\_keps\_VEF\_TrioCFD/ThHyd\_keps\_VEF.data \\
...
\end{itemize}
and on how to run TrioCFD cases with ICoCo without any exchange, but we beleive you are able to perform exchange in ICoCo with TrioCFD datafiles easily.
\end{block}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
