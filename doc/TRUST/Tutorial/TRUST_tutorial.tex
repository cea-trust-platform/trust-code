...
\title[TRUST Tutorial V1.8.4beta]{TRUST Tutorial V1.8.4beta} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\begin{itemize}
\item On new CEA Saclay PCs, TRUST versions are available with (e.g. X.Y.Z=1.8.3):\\
%\vspace{0.2cm}
\textbf{source  /home/trust\_trio-public/env\_TRUST-X.Y.Z.sh}
%\vspace{0.5cm}
\item On old CEA Saclay PCs, TRUST versions are available with (e.g. X.Y.Z=1.8.3):\\
%\vspace{0.2cm}
...
\begin{itemize}
\item Login to the CEA cluster "orcus" and initialize the TRUST environment (for example, X.Y.Z = 1.8.3): \\
{\small{
