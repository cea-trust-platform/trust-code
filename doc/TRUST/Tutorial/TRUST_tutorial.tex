...
\title[TRUST Tutorial V1.7.9beta]{TRUST Tutorial V1.7.9beta} % The short title appears at the bottom of every slide, the full title is only on the title page
