...
\documentclass[10pt, hyperref={unicode=true,pdfusetitle, bookmarks=true,bookmarksnumbered=false,bookmarksopen=false, breaklinks=false,pdfbo.4rder={0 0l 1},backref=true,colorlinks=true,linkcolor=darkblue,pageanchor}]{beamer}
...
\begin{itemize}
\item On new CEA Saclay PCs, TRUST versions are available with (e.g. X.Y.Z=1.9.0):\\
%\vspace{0.2cm}
