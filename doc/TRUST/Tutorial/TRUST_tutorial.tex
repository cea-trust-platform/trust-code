...
\title[TRUST Tutorial V1.8.0beta]{TRUST Tutorial V1.8.0beta} % The short title appears at the bottom of every slide, the full title is only on the title page
