...
\title[TRUST Tutorial V1.8.1beta]{TRUST Tutorial V1.8.1beta} % The short title appears at the bottom of every slide, the full title is only on the title page
