...
\title[TRUST Tutorial V1.8.2beta]{TRUST Tutorial V1.8.2beta} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\item We want to add a source of constituent's diffusion so copy the \textbf{Constituants\index{Constituants}} study (\textcolor{blue}{TRUST}) which will give you examples for constituents keyword used for a 2D incompressible laminar flow.
