...
\title[TRUST tutorial v1.7.2]{TRUST tutorial v1.7.2} % The short title appears at the bottom of every slide, the full title is only on the title page
...
{\small{
\textbf{source /home/triou/env\_TrioCFD\_X.Y.Z\_patch.sh }\\
\textbf{echo \$exec} \\
...
\# or for example: {\scriptsize{\textbf{/home/salome/Products/installations/SALOME-7.7.1-FD18/salome}}} \\
\# or {\scriptsize{\textbf{/export/home/salome/V7\_5\_1\_FD18\_64/salome751}}} \\
\# or {\scriptsize{\textbf{source /data/tmpsalome/salome/installations/SALOME-7.7.1-FD18/env\_products.sh} + \textbf{runSalome} or \textbf{runAppli}.}} \\
