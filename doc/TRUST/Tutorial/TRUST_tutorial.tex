...
\title[TRUST Tutorial V1.9.1beta]{TRUST Tutorial V1.9.1beta} % The short title appears at the bottom of every slide, the full title is only on the title page
