...
\title[TRUST Tutorial V1.9.5beta]{TRUST Tutorial V1.9.5beta} % The short title appears at the bottom of every slide, the full title is only on the title page
