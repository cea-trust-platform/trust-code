...
\title[TRUST Tutorial V1.7.8beta]{TRUST Tutorial V1.7.8beta} % The short title appears at the bottom of every slide, the full title is only on the title page
