...
\title[TRUST Tutorial V1.9.2beta]{TRUST Tutorial V1.9.2beta} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\textbf{cp \$project\_directory/Turbulence/share/Validation/Rapports\_automatiques/} \\
\hspace{4cm} \textbf{RANS/PeriodicBox/src/* \; .} \\
}}
...
\begin{itemize}
\item Now we are going to modify the "prepare" script in "src" directory in order to add a fourth test case: "debit4"
    \begin{itemize}
...
\item We are going to update the validation form.
    \begin{itemize}
    \item [$\circ$] Modify your validation form to run this new test case in addition to the previous test cases
