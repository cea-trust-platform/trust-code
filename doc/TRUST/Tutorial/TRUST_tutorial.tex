...
\column{.5\textwidth} 
\tableofcontents[sections={7-13}, hideallsubsections]
\end{columns}
...
\column{.5\textwidth} 
\tableofcontents[sections={7-13},currentsection, currentsubsection]
\end{columns}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hspace{0.6cm} Physical Surface("Wall") = \{1,26,34,55\};\\
\hspace{0.6cm} Physical Surface("Obstacle") = \{42,46,50,54\};\\
...
\subsection{Xprepro to create a 3D VDF mesh}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{columns}[c] 
\column{.45\textwidth}
