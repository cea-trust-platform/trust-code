...
raise_invalid_USE_MED_VERSION_exception() {
    ...
    echo ""
    echo "  Valid values are : '3.2' and '2.3'"
    echo ""
    echo "  If USE_MED_VERSION is not defined, default is 3.2"
    echo "---------------------------------------------------"
    echo ""
    exit -1
}
...
raise_invalid_external_HDF_version_exception() {
    ...
    echo ""
    echo "     MED version 3.2 ==> HDF5 version 1.8"
...
raise_invalid_external_MED_version_exception() {
    ...
    echo "  version 3.2 or version 2.3 of MED."
    echo "--------------------------------------------------------------------"
    echo ""
    exit -1
}
...
raise_HDF_version_incompatible_with_specification_exception() {
    ...
    echo "     MED version 3.2  and  HDF5 version 1.8"
