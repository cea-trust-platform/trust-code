22/11/2013 Update:
In archives/med-3.0.6.tar.gz, the .html,.map,.jpg files
have been removed to gain space disk and, above all, avoid
a slowness during install (/usr/bin/install so slow...)
on CCRT clusters (cd med-3.0.6/doc/html.dox ; rm -f *.html *.map *.jpg; Makefile.in et Makefile.am modified)
...
MED (med-3.0.7 et med-2.3.6) ainsi que celles de deux versions de HDF5
(hdf5-1.8.13  et  hdf5-1.6.9).    La  procedure  d'installation  permet
