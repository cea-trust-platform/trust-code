...
build_and_test_mc()
{
    ...
    then
       export CXXFLAGS="$CXXFLAGS -I${TRUST_ROOT}/exec/python/include/python3.12"
       export LDFLAGS="$LDFLAGS -Wl,-undefined,error -Wl,-flat_namespace -L${TRUST_ROOT}/exec/python/lib -lpython3.12"
    fi
