...
void scfft3d(isign,n,m,l,scale,x,ldx1,ldx2,y,ldy1,ldy2,table,work,isys)
...

{
 ...
 /* Variables locales */
  ...
  if (ldy1 < n/2+1) jmerreur2(nomsp,19,ldy1,n/2+1);
...
#pragma vdir nodep
    ...
    ioff = 0;
    jmscm1d(mltemp,n,fact,100,0    ,table,ntable,100+0      ,work,nwork_temp,&ioff);
