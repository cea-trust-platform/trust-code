...
Source_Generique_VDF_Face inst11;verifie_pere(inst11);
Source_Neutronique_VDF inst12;verifie_pere(inst12);
Terme_Boussinesq_VDF_Face inst13;verifie_pere(inst13);
Terme_Gravite_VDF_Face inst14;verifie_pere(inst14);
Terme_Puissance_Thermique_Echange_Impose_P0_VDF inst15;verifie_pere(inst15);
...
Terme_Source_Canal_perio_VDF_P0 inst23;verifie_pere(inst23);
