...
Op_Dift_VDF_Face inst11;verifie_pere(inst11);
Op_Dift_VDF_var_Face inst12;verifie_pere(inst12);
Op_Div_VDF_Elem inst13;verifie_pere(inst13);
Op_Grad_P0_to_Face inst14;verifie_pere(inst14);
Op_Grad_VDF_Face inst15;verifie_pere(inst15);
}
