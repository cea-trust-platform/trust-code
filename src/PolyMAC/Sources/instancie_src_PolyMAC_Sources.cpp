...
Terme_Puissance_Thermique_Echange_Impose_Elem_PolyMAC inst10;verifie_pere(inst10);
...
Terme_Source_Decroissance_Radioactive_Elem_PolyMAC inst13;verifie_pere(inst13);
