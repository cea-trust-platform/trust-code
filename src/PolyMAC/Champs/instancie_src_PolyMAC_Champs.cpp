...
Champ_Fonc_Face_PolyMAC inst2;verifie_pere(inst2);
Champ_Fonc_P0_PolyMAC inst3;verifie_pere(inst3);
Champ_Fonc_P1_PolyMAC inst4;verifie_pere(inst4);
Champ_Fonc_Q1_PolyMAC inst5;verifie_pere(inst5);
Champ_Fonc_Tabule_P0_PolyMAC inst6;verifie_pere(inst6);
