...
Op_Conv_EF_Stab_PolyMAC_Elem inst3;verifie_pere(inst3);
Op_Conv_Amont_PolyMAC_Elem inst4;verifie_pere(inst4);
Op_Conv_Centre_PolyMAC_Elem inst5;verifie_pere(inst5);
Op_Conv_EF_Stab_PolyMAC_Face inst6;verifie_pere(inst6);
Op_Diff_PolyMAC_Elem inst7;verifie_pere(inst7);
