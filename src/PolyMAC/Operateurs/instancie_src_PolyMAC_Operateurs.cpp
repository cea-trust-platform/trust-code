...
Op_Diff_K_Eps_PolyMAC_Elem inst4;verifie_pere(inst4);
Op_Diff_PolyMAC_Elem inst5;verifie_pere(inst5);
Op_Diff_PolyMAC_Face inst6;verifie_pere(inst6);
Op_Diff_PolyMAC_var_Elem inst7;verifie_pere(inst7);
Op_Diff_PolyMAC_var_Face inst8;verifie_pere(inst8);
