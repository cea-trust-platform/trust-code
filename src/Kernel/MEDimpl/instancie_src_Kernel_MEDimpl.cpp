...
void instancie_src_Kernel_MEDimpl()
{
  ...
  Champ_Fonc_MED inst1;
  verifie_pere(inst1);
  Champ_Fonc_P0_MED inst2;
  verifie_pere(inst2);
  Champ_Fonc_P1_MED inst3;
  verifie_pere(inst3);
  Champ_Fonc_Q1_MED inst4;
  verifie_pere(inst4);
  Champ_front_MED inst5;
  verifie_pere(inst5);
  Discr_inst inst6;
  verifie_pere(inst6);
  EcrMED inst7;
  verifie_pere(inst7);
  Ecrire_Champ_MED inst8;
  verifie_pere(inst8);
  Format_Post_Med inst9;
  verifie_pere(inst9);
  Integrer_champ_med inst10;
  verifie_pere(inst10);
  LataToMED inst11;
  verifie_pere(inst11);
  latatoother inst12;
