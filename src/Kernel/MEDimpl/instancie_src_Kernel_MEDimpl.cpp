...
Champ_Fonc_MED_Table_Temps inst3;verifie_pere(inst3);
Champ_Fonc_MED_Tabule inst4;verifie_pere(inst4);
Champ_Fonc_P0_MED inst5;verifie_pere(inst5);
Champ_Fonc_P1_MED inst6;verifie_pere(inst6);
Champ_Fonc_Q1_MED inst7;verifie_pere(inst7);
Champ_front_MED inst8;verifie_pere(inst8);
Discr_inst inst9;verifie_pere(inst9);
EcrMED inst10;verifie_pere(inst10);
EcrMEDfile inst11;verifie_pere(inst11);
Ecrire_Champ_MED inst12;verifie_pere(inst12);
Format_Post_Med inst13;verifie_pere(inst13);
Format_Post_Med_major inst14;verifie_pere(inst14);
Format_Post_Medfile inst15;verifie_pere(inst15);
Integrer_champ_med inst16;verifie_pere(inst16);
LataToMED inst17;verifie_pere(inst17);
