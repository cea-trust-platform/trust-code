...
EcrMEDfile inst8;verifie_pere(inst8);
Ecrire_Champ_MED inst9;verifie_pere(inst9);
Format_Post_Med inst10;verifie_pere(inst10);
Format_Post_Med_major inst11;verifie_pere(inst11);
Format_Post_Medfile inst12;verifie_pere(inst12);
Integrer_champ_med inst13;verifie_pere(inst13);
