...
void instancie_src_Kernel_Statistiques_temps()
{
  ...
  Integrale_tps_Champ inst1;
  verifie_pere(inst1);
  Integrale_tps_produit_champs inst2;
  verifie_pere(inst2);
  Moyenne_volumique inst3;
  verifie_pere(inst3);
  Op_Correlation inst4;
  verifie_pere(inst4);
  Op_Ecart_type inst5;
  verifie_pere(inst5);
  Op_Moyenne inst6;
  verifie_pere(inst6);
  Operateur_Statistique_tps inst7;
  verifie_pere(inst7);
  Operateurs_Statistique_tps inst8;
  verifie_pere(inst8);
}
