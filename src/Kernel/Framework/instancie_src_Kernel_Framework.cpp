...
Loi_horaire inst32;verifie_pere(inst32);
Old_Debog inst33;verifie_pere(inst33);
Parametre_equation inst34;verifie_pere(inst34);
Porosites inst35;verifie_pere(inst35);
Porosites_champ inst36;verifie_pere(inst36);
Postraitement inst37;verifie_pere(inst37);
Postraitement_lata inst38;verifie_pere(inst38);
Postraitements inst39;verifie_pere(inst39);
Probleme_Couple inst40;verifie_pere(inst40);
Resoudre inst41;verifie_pere(inst41);
Schema_Temps inst42;verifie_pere(inst42);
Solveur_Implicite inst43;verifie_pere(inst43);
Solveur_Masse inst44;verifie_pere(inst44);
Sonde inst45;verifie_pere(inst45);
Sonde_Int inst46;verifie_pere(inst46);
Sondes inst47;verifie_pere(inst47);
Sondes_Int inst48;verifie_pere(inst48);
Source inst49;verifie_pere(inst49);
Sources inst50;verifie_pere(inst50);
Sous_zone_dis inst51;verifie_pere(inst51);
Sous_zones_dis inst52;verifie_pere(inst52);
Testeur inst53;verifie_pere(inst53);
Zone_Cl_dis inst54;verifie_pere(inst54);
Zone_dis inst55;verifie_pere(inst55);
Zones_dis inst56;verifie_pere(inst56);
}
