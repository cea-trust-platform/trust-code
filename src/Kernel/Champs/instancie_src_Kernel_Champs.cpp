...
Champ_Front_xyz_Tabule inst18;verifie_pere(inst18);
...
Champ_Generique_refChamp_special inst33;verifie_pere(inst33);
Champ_Tabule_Morceaux inst34;verifie_pere(inst34);
