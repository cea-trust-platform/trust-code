...
Champ_Generique_refChamp_special inst32;verifie_pere(inst32);
...
Champ_front_calc_interne inst41;verifie_pere(inst41);
Champ_front_debit inst42;verifie_pere(inst42);
Champ_front_debit_massique inst43;verifie_pere(inst43);
Champ_front_fonc inst44;verifie_pere(inst44);
Champ_front_fonc_gradient inst45;verifie_pere(inst45);
Champ_front_fonc_pois_ipsn inst46;verifie_pere(inst46);
Champ_front_fonc_pois_tube inst47;verifie_pere(inst47);
Champ_front_lu inst48;verifie_pere(inst48);
Champ_front_normal inst49;verifie_pere(inst49);
Champ_front_t inst50;verifie_pere(inst50);
Champ_front_tangentiel inst51;verifie_pere(inst51);
Champ_front_txyz inst52;verifie_pere(inst52);
Champ_front_uniforme inst53;verifie_pere(inst53);
Champ_front_xyz_debit inst54;verifie_pere(inst54);
Champ_input_P0 inst55;verifie_pere(inst55);
Init_par_partie inst56;verifie_pere(inst56);
Tayl_Green inst57;verifie_pere(inst57);
champ_init_canal_sinal inst58;verifie_pere(inst58);
}
