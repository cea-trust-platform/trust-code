...
Loi_Etat_GP inst3;verifie_pere(inst3);
Loi_Etat_GR_rhoT inst4;verifie_pere(inst4);
Loi_Etat_Melange_Binaire inst5;verifie_pere(inst5);
Loi_Etat_Melange_GP inst6;verifie_pere(inst6);
Loi_Etat_Rho_T inst7;verifie_pere(inst7);
}
