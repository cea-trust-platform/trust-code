...
PDF_model inst27;verifie_pere(inst27);
...
Sortie_libre_pression_imposee inst35;verifie_pere(inst35);
Sortie_libre_pression_moyenne_imposee inst36;verifie_pere(inst36);
Temperature_imposee_paroi inst37;verifie_pere(inst37);
Traitement_particulier_NS inst38;verifie_pere(inst38);
}
