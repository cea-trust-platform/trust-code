...
Dirichlet_paroi_defilante inst15;verifie_pere(inst15);
Dirichlet_paroi_fixe inst16;verifie_pere(inst16);
...
Sortie_libre_pression_imposee inst26;verifie_pere(inst26);
