...
Frottement_interfacial_Simonnet inst7;verifie_pere(inst7);
Frottement_interfacial_Sonnenburg inst8;verifie_pere(inst8);
Frottement_interfacial_Tomiyama inst9;verifie_pere(inst9);
Frottement_interfacial_Wallis inst10;verifie_pere(inst10);
Frottement_interfacial_Weber inst11;verifie_pere(inst11);
Frottement_interfacial_bulles inst12;verifie_pere(inst12);
Masse_ajoutee_Coef_Constant inst13;verifie_pere(inst13);
Multiplicateur_diphasique_Friedel inst14;verifie_pere(inst14);
Multiplicateur_diphasique_Lottes_Flinn inst15;verifie_pere(inst15);
Multiplicateur_diphasique_Muhler_Steinhagen inst16;verifie_pere(inst16);
Multiplicateur_diphasique_homogene inst17;verifie_pere(inst17);
Portance_interfaciale_Tomiyama inst18;verifie_pere(inst18);
}
